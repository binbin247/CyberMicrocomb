...
export const copy = {
  en: {
    ...
    lockedDetuning: 'Current α',
    solitonState: 'Turnkey phase diagram',
    kerrTilt: 'Kerr-tilted response',
    lockingLine: 'Locking equilibrium',
    miComb: 'MI comb',
    soliton: 'Soliton',
    frequencyDetuning: 'Normalized detuning α = 2δω/κ',
    intracavityPower: 'Normalized intracavity power',
    language: 'Language',
    grid: 'Grid',
    play: 'Play',
    pause: 'Pause',
  ...
  zh: {
    ...
    selfFrequencyShift: 'SSFS THz',
    lockedDetuning: '当前 α',
    solitonState: 'Turnkey 相图',
    kerrTilt: 'Kerr 倾斜响应',
    lockingLine: '锁定平衡',
    miComb: 'MI 光梳',
    soliton: '孤子',
    frequencyDetuning: '归一化失谐 α = 2δω/κ',
    intracavityPower: '归一化腔内功率',
    language: '语言',
    grid: '网格',
    play: '播放',
    pause: '暂停',
