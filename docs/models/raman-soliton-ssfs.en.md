...
5. Scan `dtnNorm` to compare how pulse width and SSFS vary with detuning. Higher
   detuning usually compresses the soliton and strengthens the self-frequency
   shift, but it is also closer to a drop-out boundary, so increase it slowly
   while watching the energy trace.
